...
namespace Lab_2
{
    public partial class MainPage : ContentPage
    {
        ...
        private SearchCriteria FormCriteria()
        {
            ...
            criteria.StartOnPosition = startPicker.SelectedItem != null ? startPicker.SelectedItem as string : string.Empty;
            criteria.EndOnPosition = lastPicker.SelectedItem != null ? lastPicker.SelectedItem as string : string.Empty;
